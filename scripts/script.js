window.addEventListener('DOMContentLoaded', function () {
	...
	const toggleMenu = () => {
		...
		const btnMenu = document.querySelector('.menu'), //cам гамбургер
			menu = document.querySelector('menu'); // выплавающая форма
		const body = document.querySelector('body');

		console.log(btnMenu, menu);
		...
		body.addEventListener('click', (event) => {
			...
			if (target.closest('div') === btnMenu) {
				console.log("if (target.closest('div') === btnMenu)");
				handlerMenu();
